...
const ApiUserKeys: string[] = ['id', 'firstName', 'lastName', 'dateOfBirth', 'address']
...
function modelApiUserFromJsonContent(name: string, value: any, knownKeys: Record<string, boolean> = {}): Api.User {
	...
	const result: Api.User = {
		...
		'firstName': stringFromJson(`${name}.firstName`, value['firstName']),
		'lastName': stringFromJson(`${name}.lastName`, value['lastName']),
		'dateOfBirth': dateFromJson(`${name}.dateOfBirth`, value['dateOfBirth']),
...
function modelApiUserToJsonContent(name: string, value: Api.User, knownKeys: Record<string, boolean> = {}): ToJson<Api.User> {
	...
	const result: ToJson<Api.User> = {
		...
		'firstName': stringToJson(`${name}.firstName`, value['firstName']),
		'lastName': stringToJson(`${name}.lastName`, value['lastName']),
		'dateOfBirth': dateToJson(`${name}.dateOfBirth`, value['dateOfBirth']),
