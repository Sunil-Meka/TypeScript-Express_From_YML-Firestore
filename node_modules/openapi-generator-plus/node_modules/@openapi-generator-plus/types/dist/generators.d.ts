...
export declare type CodegenBaseGeneratorConstructor<C = CodegenGeneratorContext> = (config: CodegenConfig, context: C) => Pick<CodegenGenerator, 'toEnumMemberName' | 'toIteratedSchemaName' | 'checkPropertyCompatibility'>;
/**
...
export declare type CodegenGeneratorConstructor<C = CodegenGeneratorContext> = (config: CodegenConfig, context: C) => CodegenGenerator;
