...
function applyCodegenContentEncoding(content, encodingSpec, state) {
    ...
    const allProperties = (0, objects_1.uniquePropertiesIncludingInherited)(content.schema);
    ...
    for (const name in encodingSpec) {
        ...
        const propertyEncoding = {
            ...
            style,
            explode: (0, utils_2.convertToBoolean)(propertyEncodingSpec.explode, style === types_1.CodegenEncodingStyle.FORM),
            allowReserved: (0, utils_2.convertToBoolean)(propertyEncodingSpec.allowReserved, false),
    ...
    if (requiresMetadata(content.encoding)) {
        ...
        for (const name of __1.idx.allKeys(newSchema.properties)) {
            ...
            if (propertyRequiresMetadata(encoding, propertyEncoding)) {
                ...
                partProperty.initialValue = state.generator.initialValue((0, utils_2.toCodegenInitialValueOptions)(partProperty)) || null;
                __1.idx.set(newSchema.properties, name, partProperty);
                (0, utils_1.addToScope)(partSchema, newSchema, state);
                ...
                if (propertyEncoding.headers) {
                    ...
                    for (const [headerName, header] of __1.idx.iterable(propertyEncoding.headers)) {
                        const headerUsage = Object.assign(Object.assign({}, (0, utils_2.extractCodegenSchemaInfo)(header.schema)), { schema: header.schema, defaultValue: header.defaultValue, examples: header.examples, required: header.required });
