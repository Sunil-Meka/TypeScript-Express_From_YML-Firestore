...
function addToScope(schema, scope, state) {
    if (!(0, types_1.isCodegenNamedSchema)(schema)) {
        throw new Error(`Cannot add schema without a name to a scope: ${(0, stringify_1.debugStringify)(schema)}`);
    }
    if (scope) {
        if (!scope.schemas) {
