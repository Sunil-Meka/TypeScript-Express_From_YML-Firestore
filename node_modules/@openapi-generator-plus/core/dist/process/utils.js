...
function extractCodegenTypeOptions(source) {
    if ((0, types_1.isCodegenSchemaUsage)(source)) {
...
function toCodegenDefaultValueOptions(usage) {
    return Object.assign(Object.assign(Object.assign({}, extractCodegenTypeOptions(usage.schema)), usage), { component: usage.schema.component });
}
