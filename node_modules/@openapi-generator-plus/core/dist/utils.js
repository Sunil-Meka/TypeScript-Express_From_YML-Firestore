...
exports.chainedCompare = exports.stringLiteralValueOptions = exports.toSpecVersion = void 0;
...
function toSpecVersion(root) {
    if ((0, openapi_type_guards_1.isOpenAPIV2Document)(root)) {
        ...
        throw new Error(`API specification document not recognised as Swagger or OpenAPI: ${(0, stringify_1.debugStringify)(root)}`);
    }
}
